 ...
 */
public class GetAdwordsRefreshToken {
	...
	public static void main(String[] args) throws Exception {
		...
		String configFile = arguments.get("config");
		if (configFile == null) {
			System.out.println("Usage: java -cp adwords.jar tools.GetBingRefreshToken --config <configFile>");
			System.exit(1);
		}
		File config = new File(configFile);
		if (!config.isFile()) {
			System.out.println("cannot find file: "+configFile);
			System.out.println("Usage: java -cp adwords.jar tools.GetBingRefreshToken --config <configFile>");
			System.exit(1);
		}
